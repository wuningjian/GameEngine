...
ID2D1HwndRenderTarget	*pRenderTarget = nullptr; // 渲染对象，即画布
ID2D1SolidColorBrush	*pLightSlateGrayBrush = nullptr; // 画笔
ID2D1SolidColorBrush	*pCornflowerBlueBrush = nullptr; // 画笔
...
// 释放画布，画笔对应的GPU资源 比如窗口大小改变，窗口被销毁等
...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    // 处理窗口变化，尺寸变化了通知GPU调整画布大小（抛弃之前所有绘图资源，重新建立一套画布画笔）
	case WM_SIZE:
		if (pRenderTarget != nullptr)
		{
			RECT rc;
    ...
    case WM_DISPLAYCHANGE:
        InvalidateRect(hWnd, nullptr, false); // 通知窗口客户区域重新绘制
        wasHandled = true;
        break;
    }
